...
class TestReconcileDeploymentCreate():
    ...
    @patch("sw_operator.reconcilers.deployment.apps_v1")
    def test_creates_deployment_when_not_exists(self, mock_apps_v1, base_spec, owner_reference, mock_logger):
    ...
    @patch("sw_operator.reconcilers.deployment.apps_v1")
    def test_patch_deployment_when_exists(self, mock_apps_v1, base_spec, owner_reference, mock_logger):
    ...
    @patch("sw_operator.reconcilers.deployment.apps_v1")
    def test_raises_temporary_error_on_api_failure(self, mock_apps_v1, base_spec, owner_reference, mock_logger):
        """
        ...
        mock_apps_v1.create_namespaced_deployment.side_effect = ApiException(status=500)
